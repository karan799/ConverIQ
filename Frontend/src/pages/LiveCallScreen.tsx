        ...
        <div className="lg:col-span-1 overflow-y-auto space-y-3 pr-2 scrollbar-thin">
          ...
          <div className="bg-gradient-to-br from-red-900/50 to-orange-900/50 backdrop-blur-sm border border-red-500/20 rounded-xl p-4">
            ...
            <div className="mb-4">
              <div className="flex items-center gap-1 h-12 justify-center">
                {[...Array(20)].map((_, i) => (
                  <div
                    key={i}
                    className={`w-1.5 rounded-full transition-all duration-75 ${isRecording && audioLevel * 20 > i
            ...
            <button
              ...
              className={`w-full py-4 rounded-xl font-semibold text-lg transition-all flex items-center justify-center gap-3 ${isRecording
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-3">
              ...
              <div className="flex items-end gap-1">
                <span className={`text-2xl font-bold ${(metrics.sentiment_score || 0) >= 20 ? 'text-green-400' :
              ...
              <div className="w-full bg-white/10 rounded-full h-1 mt-1">
                <div
                  className={`h-1 rounded-full transition-all ${(metrics.sentiment_score || 0) >= 20 ? 'bg-green-500' :
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-3">
              ...
              <div className="flex gap-1 flex-wrap">
                {messages.filter(m => m.speaker === 'Client').slice(-8).map((msg, i) => (
                  <span key={i} className={`w-6 h-6 flex items-center justify-center rounded text-xs ${msg.sentiment_label === 'POSITIVE' ? 'bg-green-500/30' :
